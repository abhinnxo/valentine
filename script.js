...
document.addEventListener('DOMContentLoaded', () => {
    const elementsToAnimate = document.querySelectorAll('.feature-card, .product-card, .testimonial-card, .section-header');
...
const revealElements = document.querySelectorAll('.section-header, .features-grid, .products-grid, .testimonials-grid');
